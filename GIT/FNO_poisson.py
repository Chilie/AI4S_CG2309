...
parser.add_argument('--path_model', type=str, default='./model/FNO_grid/FNOg_2500_cw2_m12_lr0.001-500-0.5_nolizTrue.model', help="path of model for testing")
...
for ep in range(epochs):
    ...
    if cfg.state=='eval':
        savemat('predictions/FNO_grid/FNOg_predict_' + string + '.mat', {'predict': predict.detach().cpu().numpy()})
        savemat('predictions/FNO_grid/FNOg_error_' + string + '.mat',
        ...
        savemat('predictions/FNO_grid/FNOg_median_' + string + '_id' + str(idx_median) +'.mat', {'input':input, 'output': output, 'output_true':output_true})
        # max
        ...
        savemat('predictions/FNO_grid/FNOg_max_' + string + '_id' + str(idx_max) + '.mat',
